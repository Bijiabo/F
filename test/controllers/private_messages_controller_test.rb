...
class PrivateMessagesControllerTest < ActionController::TestCase
  ...
  test "should create private_message" do
    assert_difference('PrivateMessage.count') do
      post :create, private_message: { content: @private_message.content, fromUser_id: @private_message.fromUser_id, picture: @private_message.picture, toUser_id: @private_message.toUser_id }
    end
  ...
  test "should update private_message" do
    patch :update, id: @private_message, private_message: { content: @private_message.content, fromUser_id: @private_message.fromUser_id, picture: @private_message.picture, toUser_id: @private_message.toUser_id }
    assert_redirected_to private_message_path(assigns(:private_message))
  end
